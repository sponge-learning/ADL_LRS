...
class ActivityTests(TestCase):
    ...
    def test_get_def(self):
        ...
        self.assertEqual(len(list(rsp_dict['definition']['name'].keys())), 1)
    ...
    def test_get_crp_multiple_choice(self):
        ...
        rsp_dict = json.loads(rsp)
        self.assertEqual(len(list(rsp_dict['definition']['description'].keys())), 1)
        self.assertEqual(len(list(rsp_dict['definition']['choices'][0]['description'].keys())), 1)
        self.assertEqual(len(list(rsp_dict['definition']['choices'][1]['description'].keys())), 1)
        self.assertEqual(len(list(rsp_dict['definition']['choices'][2]['description'].keys())), 1)
        self.assertEqual(len(list(rsp_dict['definition']['choices'][3]['description'].keys())), 1)
    ...
    def test_get_crp_performance(self):
        ...
        self.assertEqual(len(list(rsp_dict['definition']['name'].keys())), 1)
        self.assertEqual(len(list(rsp_dict['definition']['description'].keys())), 1)
        self.assertEqual(len(list(rsp_dict['definition']['steps'][0]['description'].keys())), 1)
        self.assertEqual(len(list(rsp_dict['definition']['steps'][1]['description'].keys())), 1)
        self.assertEqual(len(list(rsp_dict['definition']['steps'][2]['description'].keys())), 1)
