...
class StatementFilterTests(TestCase):
    ...
    def test_since_filter_tz(self):
        ...
        path2 = "%s?%s" % (reverse(statements), urllib.parse.urlencode(param2))      
    ...
    def test_format_agent_filter(self):
        ...
        self.assertItemsEqual(list(orig_stmt['object'].keys()), list(stmt_r['object'].keys()))
        for m in stmt_r['object']['member']:
            self.assertItemsEqual(list(m.keys()), agent_params)
        self.assertItemsEqual(list(orig_stmt['context'].keys()), list(stmt_r['context'].keys()))
        self.assertItemsEqual(agent_params, list(stmt_r['context']['instructor'].keys()))
        self.assertItemsEqual(list(orig_stmt['context']['team'].keys()), list(stmt_r['context']['team'].keys()))
        ...
        self.assertItemsEqual(list(orig_stmt['context'].keys()), list(stmt_r['context'].keys()))
        self.assertItemsEqual(agent_id_param, list(stmt_r['context']['instructor'].keys()))
    ...
    def test_activity_format(self):
        ...
        self.assertItemsEqual(list(exact['verb']['display'].keys()), list(stmt['verb']['display'].keys()))
        self.assertEqual(exact['object']['objectType'], stmt['object']['objectType'])
        self.assertEqual(exact['object']['id'], stmt['object']['id'])
        self.assertItemsEqual(list(exact['object']['definition']['name'].keys()), list(stmt['object']['definition']['name'].keys()))
        self.assertItemsEqual(list(exact['object']['definition']['description'].keys()), list(stmt['object']['definition']['description'].keys()))
        self.assertEqual(exact['context']['contextActivities']['parent'][0]['id'], stmt['context']['contextActivities']['parent'][0]['id'])
        self.assertItemsEqual(list(exact['context']['contextActivities']['parent'][0]['definition']['name'].keys()), list(stmt['context']['contextActivities']['parent'][0]['definition']['name'].keys()))
        self.assertItemsEqual(list(exact['context']['contextActivities']['parent'][0]['definition']['description'].keys()), list(stmt['context']['contextActivities']['parent'][0]['definition']['description'].keys()))
        ...
        self.assertEqual(len(list(ids['verb']['display'].keys())), 1)
        ...
        self.assertEqual(len(list(canon_enus['object']['definition']['name'].keys())), 1)
        self.assertIn(list(canon_enus['object']['definition']['name'].keys())[0], list(stmt['object']['definition']['name'].keys()))
        self.assertEqual(len(list(canon_enus['object']['definition']['description'].keys())), 1)
        self.assertIn(list(canon_enus['object']['definition']['description'].keys())[0], list(stmt['object']['definition']['description'].keys()))
        self.assertEqual(canon_enus['context']['contextActivities']['parent'][0]['id'], stmt['context']['contextActivities']['parent'][0]['id'])
        self.assertEqual(len(list(canon_enus['context']['contextActivities']['parent'][0]['definition']['name'].keys())), 1)
        self.assertIn(list(canon_enus['context']['contextActivities']['parent'][0]['definition']['name'].keys())[0], list(stmt['context']['contextActivities']['parent'][0]['definition']['name'].keys()))
        self.assertEqual(len(list(canon_enus['context']['contextActivities']['parent'][0]['definition']['description'].keys())), 1)
        self.assertIn(list(canon_enus['context']['contextActivities']['parent'][0]['definition']['description'].keys())[0], list(stmt['context']['contextActivities']['parent'][0]['definition']['description'].keys()))
        ...
        self.assertEqual(len(list(canon_fr['verb']['display'].keys())), 1)
        self.assertEqual(canon_fr['object']['objectType'], stmt['object']['objectType'])
        self.assertEqual(canon_fr['object']['id'], stmt['object']['id'])
        self.assertEqual(len(list(canon_fr['object']['definition']['name'].keys())), 1)
        self.assertIn(list(canon_fr['object']['definition']['name'].keys())[0], list(stmt['object']['definition']['name'].keys()))
        self.assertEqual(len(list(canon_fr['object']['definition']['description'].keys())), 1)
        self.assertIn(list(canon_fr['object']['definition']['description'].keys())[0], list(stmt['object']['definition']['description'].keys()))
        self.assertEqual(canon_fr['context']['contextActivities']['parent'][0]['id'], stmt['context']['contextActivities']['parent'][0]['id'])
        self.assertEqual(len(list(canon_fr['context']['contextActivities']['parent'][0]['definition']['name'].keys())), 1)
        self.assertIn(list(canon_fr['context']['contextActivities']['parent'][0]['definition']['name'].keys())[0], list(stmt['context']['contextActivities']['parent'][0]['definition']['name'].keys()))
        self.assertEqual(len(list(canon_fr['context']['contextActivities']['parent'][0]['definition']['description'].keys())), 1)
        self.assertIn(list(canon_fr['context']['contextActivities']['parent'][0]['definition']['description'].keys())[0], list(stmt['context']['contextActivities']['parent'][0]['definition']['description'].keys()))
        ...
        self.assertNotEqual(list(canon_enus['object']['definition']['name'].keys())[0],list(canon_fr['object']['definition']['name'].keys())[0])
        self.assertNotEqual(list(canon_enus['object']['definition']['description'].keys())[0],list(canon_fr['object']['definition']['description'].keys())[0])
        self.assertNotEqual(list(canon_enus['context']['contextActivities']['parent'][0]['definition']['name'].keys())[0], list(canon_fr['context']['contextActivities']['parent'][0]['definition']['name'].keys())[0])
        self.assertNotEqual(list(canon_enus['context']['contextActivities']['parent'][0]['definition']['description'].keys())[0], list(canon_fr['context']['contextActivities']['parent'][0]['definition']['description'].keys())[0])
    ...
    def test_voidedStatementId(self):
        ...
        pathv = "%s?%s" % (reverse(statements), urllib.parse.urlencode(paramv))
    ...
    def test_more_attachments_with_payloads(self):
        ...
        payload_list1 = ["This is a text attachment1","This is a text attachment2"]
        payload_list2 = ["This is a text attachment3","This is a text attachment4"]
        ...
        path = "%s?%s" % (reverse(statements_more,kwargs={'more_id':resp_id}), urllib.parse.urlencode(param))
    ...
    def test_related_activities_filter_more(self):
        ...
        path = "%s?%s" % (reverse(statements),urllib.parse.urlencode(get_param))
        r = self.client.get(path, X_Experience_API_Version="1.0", Authorization=self.auth)
        self.assertEqual(r.status_code, 200)
