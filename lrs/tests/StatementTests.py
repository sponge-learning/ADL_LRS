...
class StatementTests(TestCase):
    ...
    def test_existing_stmtID_put(self):
        ...
        path = "%s?%s" % (reverse(statements), urllib.parse.urlencode({"statementId":guid}))
    ...
    def test_cors_post_put(self):
        ...
        path = "%s?%s" % (reverse(statements), urllib.parse.urlencode({"method":"PUT"}))
    ...
    def test_issue_put(self):
        ...
        path = "%s?%s" % (reverse(statements), urllib.parse.urlencode({"statementId":stmt_id}))
    ...
    def test_all_fields_activity_as_object(self):
        ...
        nest_path = "%s?%s" % (reverse(statements), urllib.parse.urlencode(nest_param))
    ...
    def test_all_fields_substatement_as_object(self):
        ...
        nest_sub_path = "%s?%s" % (reverse(statements), urllib.parse.urlencode(nest_sub_param))        
    ...
    def test_stmts_w_same_regid(self):
        ...
        path1 = "%s?%s" % (reverse(statements), urllib.parse.urlencode(param1))
        stmt_payload1 = stmt1
    ...
    def test_void(self):
        ...
        path = "%s?%s" % (reverse(statements), urllib.parse.urlencode(paramv))
        ...
        path = "%s?%s" % (reverse(statements), urllib.parse.urlencode({"voidedStatementId":stmt_guid}))
